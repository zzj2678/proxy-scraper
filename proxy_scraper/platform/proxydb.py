...
class ProxyDBScraper(ProxyScraperBase):
    def get_urls(self):
        ...
        base_url = "http://proxydb.net/?protocol={}&anonlvl=1&anonlvl=2&anonlvl=3&anonlvl=4&min_uptime=75&country=CN"
        return [base_url.format(protocol) for protocol in protocols]
